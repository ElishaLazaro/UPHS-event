<?php 
  ...
  if(isset($_SESSION['user_id'])){
    ...
    $sql = "SELECT f_name, l_name FROM user_profile WHERE id = $id";
          ...
          <li class="menu-item open active">
            ...
            <ul class="menu-sub">
              <li class="menu-item active">
                <a href="pages-account.php" class="menu-link" id="sidebar-account-link">Account</a>
              </li>
            </ul>
          </li>
        </ul>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
              <div class="card-body">
                ...
                <form id="formAccountSettings" method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>" onsubmit="return false" class="pt-4">
                  <div class="row g-4">
                    <div class="col-md-6">
