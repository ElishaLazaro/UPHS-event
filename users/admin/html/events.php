            ...
            <div class="content-wrapper">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="modal fade" id="addLogbookModal" tabindex="-1" aria-labelledby="addLogbookModalLabel" aria-hidden="true">
                  ...
                  <form action="../../../actions/admin_addEvents.php" method="POST" enctype="multipart/form-data" class="modal-content">  
                    ...
                    <table class="table table-striped table-hover table-bordered align-middle">
                      ...
                      <?php
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                          ...
                          $imagePath = $event_image ? "../../../uploads/events/$event_image" : '';
                          $imagePreview = $event_image ? "<div class='mb-2'><img src='$imagePath' alt='Current event image' style='max-width: 200px; max-height: 150px; object-fit: cover; border-radius: 8px;' onerror='this.style.display=\"none\"'></div>" : '';

                          // Append modal HTML to $modals
                          $modals .= "
                          <div class='modal fade' id='editModal$event_id' tabindex='-1' aria-hidden='true'>
                            <div class='modal-dialog'>
                              <form action='../../../actions/admin_editEvents.php' method='POST' enctype='multipart/form-data' class='modal-content'>
                                <div class='modal-header'>
                                ...
                                <div class='modal-body'>
                                  ...
                                  <div class='mb-3'>
                                    ...
                                    $imagePreview
                                    <input type='file' 
                                          name='update_eventImage' 
                                          id='update_eventImage$event_id' 
                                          class='form-control' 
                                          accept='image/*'>
                                    <small class='text-muted'>Leave empty to keep current image. Upload new image to replace.</small>
                                  </div>
                                </div>
                                <div class='modal-footer'>
