...
/**
 * Countdown pool is all approved events not yet ended (ignores public list filters).
 * Main priority (is_featured): earliest upcoming among those. Otherwise: random upcoming event.
 *
