...
<body>
            ...
            <div class="nav-menu">
                <nav class="mainmenu mobile-menu">
                    <ul>
                        ...
                        <li><a href="./speaker.php">Announcement</a></li>
    ...
    <!-- Hero Section Begin -->
    <section class="hero-section set-bg" data-setbg="img/banner.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <!-- <div class="hero-text">
    ...
    <section class="home-about-section spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="ha-text">
                        <h3>About University of Perpetual</h3>
                        <p>The University of Perpetual Help System – GMA Campus (UPHS-GMA) is one of the satellite campuses of the UPH JONELTA system, located in San Gabriel, General Mariano Alvarez, Cavite. Established in 1997, the campus continues the legacy of the Perpetual Help System in providing quality education rooted in the motto “Character Building is Nation Building.” The institution offers a wide range of academic programs from Basic Education to Senior High School, ensuring that learners receive holistic and values-oriented instruction. It also provides higher education programs in various fields such as Nursing, Engineering, Information Technology, Business Administration, Tourism, and Allied Health Sciences, preparing students to become competent professionals in their chosen careers.</p>
                        <!-- <ul>
    ...
    <!-- Deans of every Department -->
    <section class="team-member-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Who’s the Dean and the Board Member</h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <p>Do not miss anything program about the event</p>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>TOP 3</h2>
                        <p>SCHOOL CLUB OF UNIVERSITY OF PERPETUAL</p>
                    </div>
                </div>
            </div>
