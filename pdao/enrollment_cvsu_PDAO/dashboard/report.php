...
$allSql = "SELECT * FROM enrollees $whereClause ORDER BY enrollee_id DESC";
...
$_SESSION['report_data'] = $all_report_data;
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="sb-nav-fixed">
  ...
  <div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
      <main>
        <section class="admin-panel" aria-label="Report panel">
          <div class="d-flex align-items-center justify-content-between mb-3">
            <h2 class="m-0">Report</h2>
            <div class="d-flex align-items-center">
              <a class="btn btn-primary ms-auto" href="php/generate_report.php">Generate Report</a>
            </div>
          ...
          <?php if (!empty($searchTerm)): ?>
            <div class="alert alert-info" role="alert">
              ...
              <a href="report.php" class="ms-2">View all</a>
            </div>
          <?php endif; ?>
            ...
            <table class="table table-hover table-borderless shadow-sm mb-0 custom-table">
              <thead class="bg-light text-center">
                <tr>
                  ...
                  <th class="text-muted py-3">Sex</th>
