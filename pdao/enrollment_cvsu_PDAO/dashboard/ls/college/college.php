...
$searchTerm = '';
$conditions = [];
$conditions[] = "educational_attainment = 'COLLEGE'";
...
<body class="sb-nav-fixed">
  ...
  <div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
      <main>
        <section class="admin-panel" aria-label="College panel">
          <div class="d-flex align-items-center mb-3">
            <h2 class="m-0">College</h2>
          </div>
          ...
          <form method="GET" class="mb-3">
            ...
            <div class="input-group">
              ...
              <?php if (!empty($searchTerm) || !empty($programFilter)): ?>
                <a href="college.php" class="btn btn-outline-secondary">
          ...
          <div class="grade-nav-wrapper mb-3">
            <ul class="nav grade-nav flex-nowrap">
              ...
              foreach ($validPrograms as $prog):
                ...
                $clearHref = 'college.php' . (!empty($searchTerm) ? '?search=' . urlencode($searchTerm) : '');
              ?>
                <li class="nav-item">
