...
$searchTerm = '';
$conditions = [];
$conditions[] = "educational_attainment = 'SENIOR HIGH SCHOOL'";
...
if (!empty($gradeFilter) && in_array($gradeFilter, $validGrades)) {
  $eg = mysqli_real_escape_string($conn, $gradeFilter);
  $conditions[] = "previous_level = '$eg'";
}
...
<body class="sb-nav-fixed">
  ...
  <div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
      <main>
        <section class="admin-panel" aria-label="Senior High School panel">
          <div class="d-flex align-items-center mb-3">
            <h2 class="m-0">Senior High School</h2>
          </div>
          ...
          <form method="GET" class="mb-3">
            ...
            <div class="input-group">
              ...
              <?php if (!empty($searchTerm) || !empty($gradeFilter)): ?>
                <a href="sh.php" class="btn btn-outline-secondary">
